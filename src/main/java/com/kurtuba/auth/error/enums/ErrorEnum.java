...
public enum ErrorEnum {
    ...
    USER_EMAIL_VERIFICATION_CODE_INVALID("Wrong email verification code",1308),
    USER_EMAIL_VERIFICATION_CODE_EXPIRED("Email verification code expired",1309),
    ...
    USER_PASSWORD_RESET_CODE_INVALID("Password reset code invalid",1313),
    USER_PASSWORD_RESET_CODE_EXPIRED("Password reset code expired",1314),
    USER_META_CHANGE_INVALID_OPERATION("Invalid meta modification",1315),
    USER_META_CHANGE_CODE_MISMATCH("Code mismatch",1316),
    USER_ACTIVATION_CODE_EXPIRED("Activation code expired",1317),
    USER_ACTIVATION_INVALID("Account activation invalid",1318),
